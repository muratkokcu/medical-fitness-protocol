...
// Removed ClipboardIcon - no longer needed
...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: <UsersIcon />,
      label: 'Müşteriler',
      active: location.pathname.startsWith('/dashboard/clients')
    },
    {
      path: '/dashboard/assessments',
      icon: <ClipboardCheckIcon />,
      label: 'Değerlendirmeler',
      active: location.pathname.startsWith('/dashboard/assessments')
    },
    {
          ...
          <div className="logo">
            <div className="logo-icon">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19 14C20.49 12.54 22 10.79 22 8.5C22 7.04131 21.4205 5.64236 20.3891 4.61091C19.3576 3.57946 17.9587 3 16.5 3C15.04 3 13.7 3.55 12.71 4.5C12.1673 3.81226 11.4806 3.24876 10.6975 2.84945C9.91441 2.45013 9.05313 2.22417 8.17611 2.18651C7.2991 2.14885 6.42425 2.30033 5.61275 2.62979C4.80124 2.95925 4.07028 3.45929 3.47203 4.09441C2.87378 4.72953 2.42244 5.48564 2.14718 6.31302C1.87191 7.14039 1.77944 8.0189 1.87646 8.88736C1.97348 9.75582 2.25737 10.5934 2.71075 11.3438C3.16413 12.0943 3.77646 12.7387 4.5 13.23L4.5 18.5C4.5 19.0304 4.71071 19.5391 5.08579 19.9142C5.46086 20.2893 5.96957 20.5 6.5 20.5H11V14H13V20.5H17.5C18.0304 20.5 18.5391 20.2893 18.9142 19.9142C19.2893 19.5391 19.5 19.0304 19.5 18.5L19 14Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            {isSidebarOpen && <span className="logo-text">Medical Fitness</span>}
          </div>
          {!isMobile && (
            <button 
